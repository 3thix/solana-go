...
[![GoDoc](https://pkg.go.dev/badge/github.com/3thix/solana-go?status.svg)](https://pkg.go.dev/github.com/3thix/solana-go@v1.12.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/3thix/solana-go/releases)
[![Build Status](https://github.com/3thix/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/3thix/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/3thix/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/3thix/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/3thix/solana-go)](https://goreportcard.com/report/github.com/3thix/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/3thix/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/3thix/solana-go@v1.12.0
```
...
You can wait for a transaction confirmation using the `github.com/3thix/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/3thix/solana-go/programs/address-lookup-table"
	"github.com/3thix/solana-go/rpc"
...
import (
  ...
  "github.com/3thix/solana-go"
  "github.com/3thix/solana-go/programs/system"
  "github.com/3thix/solana-go/rpc"
  "github.com/3thix/solana-go/text"
)
...
import (
  ...
  "github.com/3thix/solana-go/rpc"
  "github.com/3thix/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/3thix/solana-go/programs/system"
  "github.com/3thix/solana-go/rpc"
  confirm "github.com/3thix/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/3thix/solana-go/rpc/jsonrpc"
  "github.com/3thix/solana-go/rpc/ws"
  "github.com/3thix/solana-go/text"
)
...
import (
  ...
  "github.com/davecgh/go-spew/spew"
  bin "github.com/gagliardetto/binary"
  solana "github.com/3thix/solana-go"
  "github.com/3thix/solana-go/programs/token"
  "github.com/3thix/solana-go/rpc"
)
